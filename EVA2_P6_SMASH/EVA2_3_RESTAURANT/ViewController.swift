...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
   ...
   // }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {//arreglo en la tabla ler cuando usa scroll
        ...
        celda.lema.text = "Siempre la mejor comida"
        ...
        if segue.identifier == "detalle"{
            if let indexPath = tableView.indexPathForSelectedRow {
                   ...
                   // detalleViewController.sdes = "Far Far away... "
                    detalleViewController.noRs = Datos[indexPath.row]
                    detalleViewController.plat = platillo[indexPath.row]
                
                    detalleViewController.imgp = imgd[indexPath.row]
